# -*- coding: utf-8 -*-
"""
Created on Thu May 21 19:16:52 2015

@author: bolaka
starts with
rmsle of registered working =  0.308726520281
rmsle of casual working =  0.514066446567
"""
...
combined.drop(['weather_name', 'heavy_rain'], axis=1, inplace=True) # 
...
featuresUnused21 = [ 'casual', 'registered', 'count', 'registered_log10', 'casual_log10', 'registered_box', 'casual_box', 
                    'workingday', 'atemp', 'temp', 'holiday', # 'weather',
                    'hour', 'weekday', 'year',
                    'clear_weather', 'mist_cloudy', 'light_rain', 'summer' , 'fall', 'winter', 'spring',
                    'sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', #'spring', '2012', 
                    'weather_hr', 'almost_holiday', 'weekday_hr', 'rush_hour', 'season_hr' # 'morning_weather', 'weather_lag', 'weekend_lag', 'weekend_lead', 'holiday_lag', 'holiday_lead'
#                    'daylight_savings' 
                    ]
