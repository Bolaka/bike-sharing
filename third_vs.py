# -*- coding: utf-8 -*-
"""
Created on Thu May  7 16:10:53 2015
...
#featuresUnused = [ 'casual','registered','count', 'timestamp' ] # ,, 'year', 'atemp'
#results = analyzeMetricNumerical('count',training, featuresUnused)
#showFeatureImportanceNumerical(training, results['features'], 'count')
#
#temp = predict(results['model'], testing[results['features']], 'count')
#testing['count'] = temp['count']

featuresUnused1 = [ 'casual','registered','count', 'timestamp', 'atemp', 'windspeed', 
                   'registered_log10', 'casual_log10', 'temp', 'humidity' ] # , 'season'
